...
- **เสียงแจ้งเตือน:** ไซเรน / บี๊บ / กริ๊ง แยกตามเซนเซอร์ (ตั้งที่ `sound=` ใน `METRICS`) ปรับความดัง และทดสอบเสียงได้ที่แถบซ้าย
  - เบราว์เซอร์จะเล่นเสียงได้หลังคลิกบนหน้าเว็บอย่างน้อย 1 ครั้ง (นโยบายกันเว็บเปิดเสียงเอง)

- **Log เหตุการณ์แจ้งเตือน** (แท็บ 🔔): รวมค่าที่เกินต่อเนื่องเป็น 1 เหตุการณ์ (นับจำนวนครั้ง/ค่าหนักสุด/ระยะเวลา)
  - ปุ่ม **รับทราบ** (หยุดเสียงซ้ำ) และ **แก้ไขแล้ว** (ปิดเหตุการณ์ + ใส่หมายเหตุ) · รับทราบทั้งหมด · ลบที่จบแล้ว · ดาวน์โหลด CSV
  - ระดับความรุนแรงตั้งที่ `severity=` ใน `METRICS` ("critical" / "warning")
  - log เก็บในหน้าเว็บของแต่ละคน — รีโหลดหน้าแล้วจะเริ่มใหม่
